...
while True:
    ...
    match PacketID:
        ...
        case 8:
            ...
            print(f'{"Personal :":<21s}'
                  f'{floor(SOB / (1000 * 60)):>1d}:{(SOB / 1000) % 60:>06.3f}'
                  ...
                  + f'-' * 65 +
                  f'\n{"AI":>9s}{"Time":>8s}{"SoB":>10s}{"PB":>9s}{"AVG-T3":>11s}{"AVG-T10":>9s}{"AVG":>7s}')
            ...
            for Current, Next in zip_longest(sorted(Filtered), sorted(Filtered)[1:]):
                ...
                for Step in range(Gap):
                    ...
                    print(f'{"" if Generated else "(" + str(len(CurrentTime)) + ")":>5} '
                          f'{"*" + str(Difficulty) if Generated else Difficulty:^4}'
            ...
            print('Suggested:{recSOB:>17}{recPB:>9}{recPB3:>9}{recPB10:>9}{recAVG:>9}'.format(
